...
public class OrganizerInstrumentedTest {
    ...
    public void setUp() {
        organizer = new User(
                "org1", "John Organizer", "john@example.com",
                "1234567890", false, true, false
        );
        regularUser = new User(
                "user1", "Jane User", "jane@example.com",
                "0987654321", false, false, false
        );
        bannedOrganizer = new User(
                "org2", "Banned Bob", "bob@example.com",
